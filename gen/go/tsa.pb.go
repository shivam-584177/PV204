...
const file_tsa_proto_rawDesc = "" +
	...
	"\x06pubkey\x18\x05 \x01(\fR\x06pubkey2\xae\x02\n" +
	...
	"\tGetResult\x12\x11.tsa.v1.SignJobId\x1a\x12.tsa.v1.SignResult\x12/\n" +
	"\fReportResult\x12\x12.tsa.v1.SignResult\x1a\v.tsa.v1.Ack2g\n" +
	"\rSignerService\x12-\n" +
	"\x06Health\x12\r.tsa.v1.Empty\x1a\x14.tsa.v1.HealthStatus\x12'\n" +
...
var file_tsa_proto_depIdxs = []int32{
	...
	7, // 5: tsa.v1.CoordinatorService.ReportResult:input_type -> tsa.v1.SignResult
	0, // 6: tsa.v1.SignerService.Health:input_type -> tsa.v1.Empty
	6, // 7: tsa.v1.SignerService.Relay:input_type -> tsa.v1.TssPacket
	1, // 8: tsa.v1.CoordinatorService.RegisterNode:output_type -> tsa.v1.Ack
	3, // 9: tsa.v1.CoordinatorService.Health:output_type -> tsa.v1.HealthStatus
	1, // 10: tsa.v1.CoordinatorService.StartSigning:output_type -> tsa.v1.Ack
	1, // 11: tsa.v1.CoordinatorService.Relay:output_type -> tsa.v1.Ack
	7, // 12: tsa.v1.CoordinatorService.GetResult:output_type -> tsa.v1.SignResult
	1, // 13: tsa.v1.CoordinatorService.ReportResult:output_type -> tsa.v1.Ack
	3, // 14: tsa.v1.SignerService.Health:output_type -> tsa.v1.HealthStatus
	1, // 15: tsa.v1.SignerService.Relay:output_type -> tsa.v1.Ack
